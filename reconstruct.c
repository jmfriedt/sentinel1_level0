...
float NRL3[10]={.1702,.5107,.8511,1.1916,1.5321,1.8726,2.2141,2.5536,2.8942,3.3744};
float NRL4[17]={.1130,.3389,.5649,.7908,1.0167,1.2428,1.4687,1.6947,1.9206,2.1466,2.3725,2.5985,2.8244,3.0504,3.2764,3.6623};
...
void reconstruction(unsigned char *BRCn,unsigned char *THIDXn,int *hcode,int NQ,float *result)
{int hcode_index=0,h;
 int BRCindex=0;
 int inc=128;
 do
